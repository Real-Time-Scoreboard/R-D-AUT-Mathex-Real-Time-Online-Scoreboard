  ...
  <div class="mx-auto center_div" id="teamSelectedShow">
    ...
    <div>
      <p> Team A: <span id="teamA" class="selectedTeamLabel"><?php  if ($team[0] != ""){echo  "<b>".$team[0]."</b>";}?></span>
        <input type="button" class = "btn btn-default" id="unselectTeamA" value="Deselect" onclick='deselectTeam("teamA")'>
      </p>
      <p> Team B: <span id="teamB" class="selectedTeamLabel"><?php  if ($team[1] != ""){echo  "<b>".$team[1]."</b>";}?></span>
        <input type="button" class = "btn btn-default" id="unselectTeamB" value="Deselect" onclick='deselectTeam("teamB")'>
      </p>
    </div>
  </div>
</body>
